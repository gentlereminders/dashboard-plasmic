...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: 6a9S7qoQjWnb/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__w0O4Q)}>
        <div className={classNames(projectcss.all, sty.freeBox__hyGd8)} />
      </div>
      {renderPlasmicSlot({
