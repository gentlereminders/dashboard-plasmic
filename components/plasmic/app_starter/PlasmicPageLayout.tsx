...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: QDhHKcGIaPM6/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: GqZ8LDgRnH7j/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      layout={
        hasVariant(globalVariants, "screen", "mobileOnly") ? "top" : "top"
      }
      logoElement={null}
      menu={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__gUuux)}>
                <IconIcon
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__p6Xj1)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__ux0N)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
