...
import Label from "../../Label"; // plasmic-import: YpXPt7-n9hzP/component
import TextInput from "../../TextInput"; // plasmic-import: iwNyTE8xe0CC/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Sf8jEujz4mZY/component
import Description from "../../Description"; // plasmic-import: oU48Ztflqujy/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: u2LpMw0ZHIFT/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___2ZCtp, {
          [sty.freeBoxiconEnd___2ZCtPmb6Ik]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___2ZCtPpdI7X]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___2ZCtpRi30C]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wG8, {
            [sty.freeBoxiconStart__wG8PdI7X]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__wG8Ri30C]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fNu2O)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iWkU, {
            [sty.freeBoxiconEnd__iWkUmb6Ik]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__iWkUpdI7X]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__xJy7Z)}
                role={"img"}
              />
            ),
