...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: RLyIK-yo7ZqP/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: U40evRWJrBx0/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: V0A4G0UARQdz/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg___8D7Bk)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___6LyU)}
            role={"img"}
          />
        ) : null}
      </div>
