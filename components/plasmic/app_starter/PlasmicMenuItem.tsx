...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: LL-QPvNmlgAY/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___5Qunh)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__mVo2E)}>
            <div
              className={classNames(
                projectcss.all,
