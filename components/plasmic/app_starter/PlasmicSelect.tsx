...
import MenuPopover from "../../MenuPopover"; // plasmic-import: xWbayfTwfnW-/component
import MenuItem from "../../MenuItem"; // plasmic-import: LL-QPvNmlgAY/component
import MenuSection from "../../MenuSection"; // plasmic-import: z6LPtey2w4d-/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: xTyxb5PZ32kb/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__ul3Vp)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
