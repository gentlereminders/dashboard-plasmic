...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: GMgVlqL8RbBE/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: dLJnxwJk_5lp/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__bPvSp)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__adxVl)}
            label={"Open Popover"}
          />
        ),
