...
import Checkbox from "../../Checkbox"; // plasmic-import: RLyIK-yo7ZqP/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: dzJtb-xJ1A4T/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__kVyD)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__cnbFi)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__bi5G3)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__mOal4)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
