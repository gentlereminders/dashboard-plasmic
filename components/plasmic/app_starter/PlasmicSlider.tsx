...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: TumZL_khovpc/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__yyblW)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__q8NvS)}>
        <div
