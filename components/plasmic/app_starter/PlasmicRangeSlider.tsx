...
import SliderThumb from "../../SliderThumb"; // plasmic-import: w30u3cFocgH3/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: E8-4ee4SH7sm/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jcwN2)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__a00VF)}>
        <div
